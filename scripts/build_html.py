...
for root, _, files in os.walk(SRC_DIR):
    for file in files:
        if file.endswith(".html") or file.endswith(".js"):
            ...
            header = []
            header.append("// THIS FILE IS AUTOGENERATED, DO NOT EDIT MANUALLY\n")
            header.append("#pragma once\n")
            header.append("#include <cstddef>\n")

            # Write the compressed data as a byte array
            header.append(f"constexpr char {base_name}[] PROGMEM = {{\n")
            ...
            header.append("};\n")
            header.append(f"constexpr size_t {base_name}CompressedSize = {len(compressed)};\n")
            header.append(f"constexpr size_t {base_name}OriginalSize = {len(processed)};\n")

            changed = write_if_changed(header_path, "".join(header))
